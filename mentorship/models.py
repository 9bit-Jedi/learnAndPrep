...
class Mentee(models.Model):
    ...
    user = models.OneToOneField(
        to=User, related_name="mentee", on_delete=models.CASCADE
    )
...
class MentorMenteeRelationship(models.Model):
    mentee = models.OneToOneField(
        to=Mentee, related_name="relationships", on_delete=models.CASCADE
    )

    alloted_mentor = models.ForeignKey(
        to=Mentor, related_name="relationships", on_delete=models.CASCADE
    )
    alloted_mentor_compatibility = models.FloatField()

    extra_mentor_1 = models.ForeignKey(
        to=Mentor, related_name="relationships_1", on_delete=models.CASCADE
    )
    extra_mentor_1_compatibility = models.FloatField()
    extra_mentor_2 = models.ForeignKey(
        to=Mentor, related_name="relationships_2", on_delete=models.CASCADE
    )
    extra_mentor_2_compatibility = models.FloatField()
    extra_mentor_3 = models.ForeignKey(
        to=Mentor, related_name="relationships_3", on_delete=models.CASCADE
    )
