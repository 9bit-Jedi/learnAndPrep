...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', shortuuid.django_fields.ShortUUIDField(alphabet=None, editable=False, length=22, max_length=22, prefix='', primary_key=True, serialize=False)),
                ('status', models.CharField(choices=[('Attempted', 'Attempted'), ('Marked', 'Marked for Review'), ('Skipped', 'not visited'), ('Unattempted', 'Unattempted'), ('SaveMarked', 'Saved and Marked for Review')], max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField()),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='mockTest.test')),
            ],
            options={
